...
public class Comp_Expert extends AppCompatActivity implements PaymentResultListener {
    Button next;
    FirebaseDatabase database = FirebaseDatabase.getInstance();
    DatabaseReference myRef = database.getReference("ComputerExperts");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_comp__expert);
        init();
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (user_name.isEmpty() && user_email.isEmpty() && user_number.isEmpty() && Description.isEmpty()) {
                    Toast.makeText(Comp_Expert.this, "Please fill the details", Toast.LENGTH_SHORT).show();
                } else {
                    builder = new AlertDialog.Builder(Comp_Expert.this);
    ...
    public void onPaymentSuccess(String s) {
        ...
        Toast.makeText(Comp_Expert.this, "Details Filled.",
                Toast.LENGTH_SHORT).show();
        startActivity(new Intent(Comp_Expert.this, Complaints.class));
        finish();
    ...
    public void onPaymentError(int i, String s) {
        Toast.makeText(Comp_Expert.this, "Payment Failed.",
                Toast.LENGTH_SHORT).show();
        startActivity(new Intent(Comp_Expert.this, Complaints.class));
        finish();
