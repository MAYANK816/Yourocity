...
import com.example.allinone.SignUp;
...
public class Plumber extends AppCompatActivity implements PaymentResultListener {
    Button next;
    FirebaseDatabase database = FirebaseDatabase.getInstance();
    DatabaseReference myRef = database.getReference("Plumber");
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (user_name.isEmpty() && user_email.isEmpty() && user_number.isEmpty() && Description.isEmpty()) {
                    ...
                    Toast.makeText(Plumber.this, "Please fill the details", Toast.LENGTH_SHORT).show();
                } else {
                    builder = new AlertDialog.Builder(Plumber.this);
    ...
    public void Checkout() {
        ...
        try {
            ...
            options.put("amount", "15000");//pass amount in currency subunit
    ...
    public void onPaymentSuccess(String s) {
        ...
        Toast.makeText(Plumber.this, "Details Filled.",
                Toast.LENGTH_SHORT).show();
        startActivity(new Intent(Plumber.this, Complaints.class));
        finish();
    ...
    public void onPaymentError(int i, String s) {
        Toast.makeText(Plumber.this, "Payment Failed.",
                Toast.LENGTH_SHORT).show();
        startActivity(new Intent(Plumber.this, Complaints.class));
        finish();
    }
